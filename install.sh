...
echo "Creating ~/.logmem directory structure (remember-everything-locally-super-duper-securly)..."
...
PLIST="$HOME/Library/LaunchAgents/com.user.remember-everything-watch.plist"
sed "s|REPLACE_HOME|$HOME|g" "$SCRIPT_DIR/templates/launchagent.plist" > "$PLIST"
launchctl unload "$PLIST" 2>/dev/null || true
launchctl load "$PLIST"
launchctl start com.user.remember-everything-watch 2>/dev/null || true
...
# ── Done ─────────────────────────────────────
echo ""
echo "  ✓ remember-everything-locally-super-duper-securly installed successfully"
echo ""
echo "  Commands:"
